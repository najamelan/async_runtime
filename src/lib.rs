...
//!   - client code can decide that the executor for the thread is a LocalPool (can be a serious
//!     performance benefit sometimes)
...
//!     run just fine with the compatibility layer from futures 0.3.
//!
...
//! so I prefered keeping the API consistent with other targets, and future proof.
//
#![ feature( async_await ) ]
